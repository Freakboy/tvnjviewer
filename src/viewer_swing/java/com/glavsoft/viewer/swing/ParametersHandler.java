...
public class ParametersHandler {
	...
	private static void completeSettings(ParamsRetriever pr, ConnectionParams connectionParams, ProtocolSettings rfbSettings, UiSettings uiSettings) {
	...
	public static void completeSettingsFromApplet(final JApplet applet,
